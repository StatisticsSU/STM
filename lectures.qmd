...
### Literature
The reading suggestions marked **MSA** below are section numbers from the course book Wackerley, Mendenhall and Scheaffer (2021). [Mathematical Statistics with Applications](https://www.cengage.uk/c/mathematical-statistics-with-applications-7e-wackerly/9780495110811/), 7th edition, Cengage.
...
Read:  [basic math notes with check-up exercises](/misc/larry.png) \

**Lecture 1 - Derivation. Optimization. Integration.**\
Read: [Derivative notebook](https://observablehq.com/@mattiasvillani/the-derivative) | [Integral notebook](https://observablehq.com/@mattiasvillani/the-riemann-integral) | [Slides](/misc/larry.png) \
Widgets: [Derivative](https://observablehq.com/@mattiasvillani/the-derivative#deriv_anchor) | [Riemann integral](https://observablehq.com/@mattiasvillani/the-riemann-integral#anchor) \
Code: \
Data: \
...
Read: MSA 9.1-9.4, 9.7 | [Slides](/misc/larry.png) \
