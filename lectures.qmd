...
Read: BLprequel 1.15-1.16 | [Notebook on function optimization](https://observablehq.com/@mattiasvillani/function-optimization) | [Slides](/slides/L2Integral.pdf)  \
...
Code: [Newton-Raphson algorithm in R](code/Newton.R) | [Gradient Ascent algorithm in R](code/GradientAscent.R)
...
Read: MSA 5.1-5.8, 5.11 | BLprequel 1.16 (double integrals) | BLprequel 7.1-7.7 (alternative to MSA) | [Slides](/slides/L5JointProb.pdf) \

**Lecture 6 - Transformation of random variables. Monte Carlo simulation. Law of large numbers. Central limit theorem.**\
Read: MSA 6.1-6.4, 7.3 | Blprequel 6.1, 5.2-5.4 (alternative to MSA) | [Law of large numbers notebook](https://observablehq.com/@mattiasvillani/law-large-numbers) | [central limit theorem notebook](https://observablehq.com/@mattiasvillani/central-limit-theorem) | [Slides](/slides/L6_lln_clt.pdf) \
...
Read: BLprequel 8.4-8.6 | [Slides](/slides/L9_Information.pdf) \
...
Read: [tutorial on maximum likelihood](tutorial/numericalML/numericalML.qmd) | [Slides](/slides/L10_Optim.pdf) \
...
Read: [Slides](/slides/L12_NonLinearRegTimeSeries.pdf)\
