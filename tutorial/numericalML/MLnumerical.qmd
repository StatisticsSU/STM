...
$$\ell'(\lambda) = \frac{d}{d\lambda}\ell(\lambda) = -n + \frac{\sum_{i=1}^n y_i}{\lambda} = 0$$
...
$$\ell''(\lambda)=\frac{d^2}{d\lambda^2}\ell(\lambda) = - \frac{\sum_{i=1}^n y_i}{\lambda^2},$$
...
We can now express the approximate sampling distribution of the ML estimators of $\hat\beta_0$ and $\hat\beta_1$ :
