...
#date: ""
title: "Department of Statistics, VT 2026"
format: pdf 
classoption: 12pt
geometry:
      - top=30mm
...
This course is a continuation of the course *Statistics and Data Analysis for Computer and Systems Sciences, 15 credits*. It provides advanced and expanded knowledge in probability theory, modelling, and statistical inference theory, which forms the foundation for modern machine learning and AI. Theoretical derivations are connected with practical applications in programming languages for data analysis and machine learning. Regression and classification models are a significant part of the course. The course offers an introduction to the mathematical methods that are essential tools for the course and ends with an introduction to time series analysis.
...
-   **Modelling and prediction**: linear and non-linear regression, overfitting, regularization, classification, logistic regression, multinomial logistic regression, Poisson regression.

-   **Inference**: point estimations, bias-variance trade-off, maximum likelihood (ML), likelihood theory, numerical optimization for ML estimation.

-   **Time series**: autocorrelation, autoregressive models.
...
| [Ganna Fagerberg](https://www.su.se/profiles/g/gafa0035) | Exercises, Computer labs and Jour \vspace{5pt} |
| [Ralf Xhaferi](https://www.su.se/profiles/raxh4527-1.569769) | Exercises and Jour\vspace{5pt} |
| [Akram Mahmoudi](https://www.su.se/profiles/a/akma0227) | Exercises and Computer labs |
...
The teaching consists of 12 lectures (F1-F12), 8 exercises (Ö1-Ö8) and 2 computer lab sessions (D1-D2) according to the schedule. There are also 7 scheduled slots for getting help from one of the teaching assistants (jour). See the link to TimeEdit on the course page for the current schedule.
...
-   The use of AI (Artificial Intelligence) tools is permitted as an aid for acquiring knowledge and studying, but not for producing material for any form of examination.

-   All forms of plagiarism are prohibited and include text generated by AI tools.

-   The use of AI tools to improve a text or code originally written by the student is not permitted.

-   Text-matching software and detectors of AI-generated text are used by the department.

Stockholm University takes any form or cheating or plagiarism very seriously. As teachers we are obligated to send suspected cheating attempts to the disciplinary board for investigation. Read [Rules and Handling Procedures for Disciplinary Matters](https://medarbetare.su.se/en/support-and-service/legal/disciplinary-matters-and-expulsion).
...
-   Part 1
    ...
    -   Deadline for possible correction: May 14.
-   Part 2
    -   Deadline for submission: May 13.
    -   Feedback from teaching assistants: May 22.
    -   Deadline for possible correction: June 1.
...
The following lecture notes/book draft will be used in some parts of the course:

-   Villani, M. (2026). [Bayesian Learning - the prequel](https://github.com/mattiasvillani/BayesianLearningBook/raw/main/pdf/PreBayesBook.pdf).
