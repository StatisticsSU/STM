...
| [Ganna Fagerberg](https://www.su.se/profiles/g/gafa0035) | Exercises and Computer labs \vspace{5pt} |
...
The teaching consists of 12 lectures (F1-F12), 8 exercises (Ö1-Ö8) and 3 computer lab sessions (DL1-DL3) according to the schedule. There are also 7 scheduled slots for getting help from one of the teaching assistants (jour). See the link to TimeEdit on the course page for the current schedule.
